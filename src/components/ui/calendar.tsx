  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground w-12 h-12 text-center text-base font-medium",
        row: "flex w-full flex-wrap justify-center gap-1",
        cell: cn(
        ...
        day: cn(
          ...
          "w-12 h-12 p-0 text-base font-normal aria-selected:opacity-100"
        ),
        day_range_start:
